...
then you have already installed a box before, and you do not need to run
...
<a href="/docs/getting-started/project_setup.html" class="button inline-button prev-button">Project Setup</a>
<a href="/docs/getting-started/up.html" class="button inline-button next-button">Up And SSH</a>
