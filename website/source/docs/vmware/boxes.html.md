...
As with [every provider](/docs/providers/basic_usage.html), the VMware
...
-> **>Note:** This is a reasonably advanced topic that a beginning user of
Vagrant does not need to understand. If you are just getting started with
...
-> **Linked Clones** A future version of the VMware provider will implement
linked cloning.
