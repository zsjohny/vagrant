...
own. But you should default to mounting ephemeral drives, because they are
...
The following commands will change the WinRM 1.1 port to what is expected by
Vagrant:
